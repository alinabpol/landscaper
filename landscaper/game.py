...
def purchase_teeth():
    ...
    user_input = input('Do you have your teeth? Let\'s start cutting a lawn and get a $1 per day! (y or yes)')
...
def purchase_rusty_scissors():
    global money_earned, account_balance, my_tools
    user_input = input(f'Congrats, you\'ve earned ${account_balance[0]}, and now you can buy a pair of rusty scissors! (y or yes)')
    if user_input.lower == 'y' or 'yes':
        account_balance[0] -= 5
...
def use_scissors():
        global money_earned, account_balance, my_tools
        user_input = input(f"Start cutting lawns with {tools[1]['type']} and earn ${tools[1]['profit']}! (y or yes)")
        if user_input.lower == 'y' or 'yes':
            for b in range(5):
...
def purchase_lawnmover():
    ...
    if account_balance[0] == 25:
        user_input = input(f'Congrats, you\'ve earned ${account_balance[0]}, and now you can buy a {tools[2]["type"]}! (y or yes)')
        if user_input.lower == 'y' or 'yes':
...
def use_lanmower():
        global money_earned, account_balance, my_tools
        user_input = input(f"Start cutting lawns with {tools[2]['type']} and earn ${tools[2]['profit']}! (y or yes)")
        if user_input.lower == 'y' or 'yes':
            for b in range(5):
...
def purchase_modern_lawnmover():
    ...
    if account_balance[0] == 250:
        user_input = input(f'Congrats, you\'ve earned ${account_balance[0]}, and now you can buy a {tools[3]["type"]}! Press "Ok" to proceed with the purchase. (y or yes)')
        if user_input.lower == 'y' or 'yes':
...
def use_modern_lanmower():
        global money_earned, account_balance, my_tools
        user_input = input(f"Start cutting lawns with {tools[3]['type']} and earn ${tools[3]['profit']}! (y or yes)")
        if user_input.lower == 'y' or 'yes':
            for b in range(5):
...
def hire_students():
    ...
    if account_balance[0] == 500:
        user_input = input(f'Congrats, you\'ve earned ${account_balance[0]}, and now you can hire {tools[4]["type"]}! (y or yes)')
        if user_input.lower == 'y' or 'yes':
...
def work_with_students():
        global money_earned, account_balance, my_tools
        user_input = input(f"Start cutting lawns with {tools[4]['type']} and earn ${tools[4]['profit']}! (y or yes)")
        if user_input.lower == 'y' or 'yes':
            for b in range(5):
                if account_balance[0] < 1000 and my_tools == tools[4]["type"]:
                    money_earned += 250
                    account_balance.insert(0, money_earned)
                    print(f"You've earned ${account_balance[0]} cutting lawns with {tools[4]['type']}! (y or yes)")
                else:
